      ...
      <Container>
        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-8 lg:gap-10">
          <article className="rounded-lg border border-[var(--tone-border)] p-6 sm:p-8 bg-[var(--tone-surface)]">
            <h3 className="text-lg font-semibold text-[var(--tone-text)] mb-4">{gridHeading}</h3>
          ...
          <article className="rounded-lg border border-[var(--tone-border)] p-6 sm:p-8 bg-[var(--tone-surface)]">
            <h3 className="text-lg font-semibold text-[var(--tone-text)] mb-4">{storeHeading}</h3>
            {shopifyEmbedHtml ? (
              <div
            ...
            <p className="mt-4 text-sm text-[var(--tone-muted)]">
              Secure checkout will appear here.
            </p>
          </article>
        </div>

        <div className="mt-8 rounded-lg border border-[var(--tone-border)] bg-[var(--tone-surface)] p-6 sm:p-8">
          <h3 className="text-lg font-semibold text-[var(--tone-text)] mb-2">{supportHeading}</h3>
